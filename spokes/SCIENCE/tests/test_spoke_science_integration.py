"""
Tests d'intégration pour spoke SCIENCE
...
class TestSpokeSCIENCEIntegration:
    """Tests d'intégration spoke SCIENCE."""
    ...
    def test_verses_valid_yaml(self):
        ...
        for verse_file in self.verses_dir.glob("*.yaml"):
            with open(verse_file, 'r') as f:
                ...
                assert data["spoke"] == "SCIENCE", f"Verse {verse_file.name} mauvais spoke"
