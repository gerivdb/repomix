"""
Tests d'intégration pour spoke TECH
...
class TestSpokeTECHIntegration:
    """Tests d'intégration spoke TECH."""
    ...
    def test_verses_valid_yaml(self):
        ...
        for verse_file in self.verses_dir.glob("*.yaml"):
            with open(verse_file, 'r') as f:
                ...
                assert data["spoke"] == "TECH", f"Verse {verse_file.name} mauvais spoke"
