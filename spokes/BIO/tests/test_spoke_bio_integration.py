"""
Tests d'intégration pour spoke BIO
...
class TestSpokeBIOIntegration:
    """Tests d'intégration spoke BIO."""
    ...
    def test_verses_valid_yaml(self):
        ...
        for verse_file in self.verses_dir.glob("*.yaml"):
            with open(verse_file, 'r') as f:
                ...
                assert data["spoke"] == "BIO", f"Verse {verse_file.name} mauvais spoke"
